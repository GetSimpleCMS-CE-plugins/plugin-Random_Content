...
register_plugin(
	...
	'1.1b', 			# Version of plugin
	'Mike Henken',		# Updated for PHP 8 by AuraFX - Author of plugin
...
$toolbar = $EDTOOL == 'advanced' ? "
    ['Bold', 'Italic', 'Underline', 'NumberedList', 'BulletedList', 'JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock', 'Table', 'TextColor', 'BGColor', 'Link', 'Unlink', 'Image', 'RemoveFormat', 'Source'],
    '/',
    ['Styles', 'Format', 'Font', 'FontSize']
" : ($EDTOOL == 'basic' ? "['Bold', 'Italic', 'Underline', 'NumberedList', 'BulletedList', 'JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock', 'Link', 'Unlink', 'Image', 'RemoveFormat', 'Source']" : GSEDITORTOOL);
...
function random_content($c_category){
    if (file_exists(contentDATAFILE)) {
        $category_file = simplexml_load_file(contentDATAFILE);
...
?>
				<tr>
					<td>
						<a href="load.php?id=RandomContent&edit=<?php echo $atts['title']; ?>" title="Edit Content: <?php echo $atts['title']; ?>"> <?php echo $atts['title']; ?></a>
					</td>
					<td class="delete">
